...
const int rclkPin  = 7;  // (12) ST_CP [RCLK] on 74HC595
const int srclkPin = 6;  // (11)  SH_CP [SRCLK] on 74HC595
const int dsPin    = A0;  // (13) DS [SER] on 74HC595
